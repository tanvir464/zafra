      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We're here to help! Whether you have questions about our products, need assistance with an order, or want to share feedback, we'd love to hear from you.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 text-center">
              ...
              <p className="text-gray-600 mb-2">support@Scentareperfume.com</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 text-center">
              ...
              <p className="text-gray-600 mb-2">123 Perfume Street</p>
              <p className="text-sm text-gray-500">Fragrance City, FC 12345</p>
            </div>
          </div>
        </section>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-lg shadow-sm p-8">
                ...
                <div className="space-y-3">
                  <a href="/shipping" className="block text-purple-600 hover:text-purple-700 transition-colors">
                    • How long does shipping take?
                  </a>
                  <a href="/refund" className="block text-purple-600 hover:text-purple-700 transition-colors">
                    • What is your return policy?
                  </a>
                  <a href="/perfumes" className="block text-purple-600 hover:text-purple-700 transition-colors">
                    • How do I choose the right fragrance?
                  </a>
                  <a href="/brands" className="block text-purple-600 hover:text-purple-700 transition-colors">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            ...
            <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">123 Perfume Street, Fragrance City, FC 12345</p>
              </div>
            </div>
          </div>
        </section>
